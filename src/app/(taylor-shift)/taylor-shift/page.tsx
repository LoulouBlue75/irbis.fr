...
export default function TaylorShiftPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <section className="py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-2xl md:text-3xl text-secondary mb-4 font-light">
            Le recrutement de luxe avec précision adaptative
          </p>
          <p className="text-lg text-tertiary max-w-3xl mx-auto mb-8">
            Une expertise exclusive dédiée aux maisons de luxe, aux enseignes de prestige et aux marques iconiques.
            ...
            <Card className="border-amber-200">
              ...
              <CardContent>
                <p className="text-secondary">
                  ...
                  Chaque interaction doit être une expérience mémorable.
                </p>
              </CardContent>
            </Card>
            <Card className="border-amber-200">
              ...
              <CardContent>
                <p className="text-secondary">
                  ...
                  d'une clientèle exigeante et internationale.
                </p>
              </CardContent>
            </Card>
            <Card className="border-amber-200">
              ...
              <CardContent>
                <p className="text-secondary">
                  Notre méthodologie exclusive d'alignement en 8 dimensions garantit un matching
                  précis entre les exigences des maisons et le potentiel des talents.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 px-4 md:px-8 bg-amber-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-secondary">
                  ...
                  <li>• Parfumerie et cosmétiques de prestige</li>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Postes Clés</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-secondary">
      ...
      <section className="py-16 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-primary mb-8 text-center">
            L'Approche 8D Appliquée au Luxe
          </h2>
          <div className="grid md:grid-cols-4 gap-4">
            {[
              { title: 'Compétences', desc: 'Expertise technique et savoir-faire métier' },
              { title: 'Valeurs', desc: 'Adhésion aux codes et à l'éthique du luxe' },
              { title: 'Potentiel', desc: 'Capacité d'évolution et leadership' },
              { title: 'Culture', desc: 'Affinité avec l'univers de la marque' },
              { title: 'Soft Skills', desc: 'Intelligence relationnelle et émotionnelle' },
              { title: 'Adaptabilité', desc: 'Flexibilité face aux exigences du retail' },
              { title: 'Engagement', desc: 'Passion pour l'excellence du service' },
              { title: 'Vision', desc: 'Compréhension des enjeux stratégiques' },
            ].map((dimension, index) => (
      ...
      <section className="py-16 px-4 md:px-8 bg-amber-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-primary mb-8 text-center">Références</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardContent className="pt-6">
                <div className="text-4xl font-bold text-amber-600 mb-2">95%</div>
                <p className="text-secondary">Taux de réussite des placements</p>
              </CardContent>
            </Card>
            <Card className="text-center">
              <CardContent className="pt-6">
                <div className="text-4xl font-bold text-amber-600 mb-2">50+</div>
                <p className="text-secondary">Maisons de luxe accompagnées</p>
              </CardContent>
            </Card>
            <Card className="text-center">
              <CardContent className="pt-6">
                <div className="text-4xl font-bold text-amber-600 mb-2">200+</div>
                <p className="text-secondary">Talents placés en C-level</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 px-4 md:px-8 bg-gradient-to-r from-amber-600 to-amber-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Prêt à trouver l'excellence ?</h2>
          <p className="text-xl mb-8 opacity-90">
            Découvrez comment Taylor Shift peut transformer votre recrutement dans l'univers du luxe.
          </p>
          <Link href="https://taylor-shift.com" target="_blank" rel="noopener noreferrer">
