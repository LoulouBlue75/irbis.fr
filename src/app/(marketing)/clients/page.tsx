    ...
    <>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-12 bg-ink-navy">
        <div className="max-w-[1280px] mx-auto text-center">
          <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-foil-gold mb-10">
            Sectors
          </p>
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-light text-paper-cream tracking-tight mb-16 italic">
